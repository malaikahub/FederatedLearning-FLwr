...
Authors
Project Overview
This project demonstrates Federated Learning using the Flower (FLwr) framework. Multiple simulated clients train a neural network on the MNIST handwritten digit dataset — without ever sharing their raw data with the server.
...
Server aggregates updates (FedAvg / FedProx)
Repeat for N rounds
Project Structure
...
Framework: Flower (FLwr) | Dataset: MNIST \
